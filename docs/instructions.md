...
You can also set the options when creating a new client by passing an optional json object `new ZeroClipboard.Client( $("#d_clip_button", { moviePath: "new/path", text: "Copy me!" }))`
